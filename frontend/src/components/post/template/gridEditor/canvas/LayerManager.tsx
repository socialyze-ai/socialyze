    ...
    <div className="bg-white rounded-lg shadow p-2 w-full h-full">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-medium">Grid Layers</h3>
        </div>
        ...
        {sortedItems.length === 0 ? (
          ...
          <div className="space-y-1">
            {sortedItems.map((item, index) => {
              // Determine visual z-index for preview during drag
              const previewZIndex = dragState.previewZIndices?.[item.id];
              ...
              return (
                ...
                >
                  ...
                  {/* Layer position or preview position */}
                  <div className="text-xs text-gray-400 mr-2">
                    {previewZIndex ? (
                      <span className="text-blue-500">
                        {previewZIndex}/{totalLayers}
                      </span>
                    ) : (
                      <span>
                        {item.zIndex}/{totalLayers}
                      </span>
                    )}
                  </div>
